...
<template>
    <!-- <div class="flex flex-col bg-white p-5">
        <span class="text-8xl my-3 font-bold text-center text-black" >Galleries</span>
                <div class="flex flex-wrap justify-evenly ">
                <img class="w-2/5 h-3/4  ease-in duration-300  cursor-pointer rounded-xl m-3 " src="https://www.mercedes-benz.ru/vans/ru/sprinter/panel-van/body-variants/image-group/long-high/_jcr_content/parsysmeta/meta/image.mq6.png/1542624979000.png" alt="">
                <img class="w-2/5 h-3/4  ease-in duration-300  cursor-pointer rounded-xl m-3 " src="https://images.drive.ru/i/0/5a7ac281ec05c4b5310000a9.jpg" alt="">
                <img class="w-2/5 h-3/4  ease-in duration-300  cursor-pointer rounded-xl m-3 " src="https://images.drive.ru/i/0/5a7ac281ec05c4b5310000a9.jpg" alt="">
                <img class="w-2/5 h-3/4  ease-in duration-300  cursor-pointer rounded-xl m-3 " src="https://images.drive.ru/i/0/5a7ac281ec05c4b5310000a9.jpg" alt="">
                <img class="w-2/5 h-3/4  ease-in duration-300  cursor-pointer rounded-xl m-3 " src="https://images.drive.ru/i/0/5a7ac281ec05c4b5310000a9.jpg" alt="">
                <img class="w-2/5 h-3/4  ease-in duration-300  cursor-pointer rounded-xl m-3 " src="https://images.drive.ru/i/0/5a7ac281ec05c4b5310000a9.jpg" alt="">
