...
<template>
    <div class="grid grid-cols-12 justify-between items-center  p-1 bg-gray-800">

        <div class="col-span-6">
            <p class="text-orange-500 text-4xl my-5 font-bold" style="font-family: 'Kanit', sans-serif;">
            ...
            <button class="p-3 bg-orange-500 rounded-lg my-5 text-white text-md font-bold">
                More About Us
            </button>
        </div>
